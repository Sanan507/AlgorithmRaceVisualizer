...
public class AVLTreeModel {
  ...
  public static TreeNodeDto toDto(Node n) {
    ...
    int bf = lH - rH;
    return new TreeNodeDto(n.val, n.height, bf, "BLACK", toDto(n.left), toDto(n.right));
  }
  ...
  private Node insertRecursive(
      Node node, int val, List<TreeSimulationFrame> frames, boolean[] duplicateFound) {
    if (node == null) {
      ...
      frames.add(
          new TreeSimulationFrame(
              ...
              "Unbalanced node "
                  ...
                  + " (BF="
                  + balance
                  + "). Executing LR Rotation (Left-Rotate child "
                  + node.left.val
                  + ", then Right-Rotate "
                  + node.val
                  + ").",
      ...
      frames.add(
          new TreeSimulationFrame(
              ...
              "Unbalanced node "
                  ...
                  + " (BF="
                  + balance
                  + "). Executing RL Rotation (Right-Rotate child "
                  + node.right.val
                  + ", then Left-Rotate "
                  + node.val
                  + ").",
