...
public class SimulationService {
  ...
  /**
   * Sanitizes and clamps a client-supplied walls array to exactly [rows][cols]. Prevents oversized
   * arrays from bypassing grid dimension limits.
   */
  ...
  private RaceLaneResponse simulatePathLane(
      String name,
      int rows,
      int cols,
      int startRow,
