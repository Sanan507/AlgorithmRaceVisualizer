...
public final class ComplexityCatalog {
  ...
  static {
    ...
    add(
        ...
        "O(n^2)",
        "O(1)",
        "Improves Bubble Sort by comparing values with a shrinking gap before finishing with gap"
            + " one.",
    ...
    add(
        ...
        "O(nk)",
        "O(n+k)",
        "Non-comparison integer sorting algorithm that processes numbers digit-by-digit from least"
            + " to most significant.",
    ...
    add(
        ...
        "O(n+k)",
        "O(k)",
        "Non-comparison integer sorting algorithm that counts value frequencies to construct sorted"
            + " output.",
    ...
    add(
        ...
        "O(n²)",
        "O(1)",
        "A bidirectional variation of Bubble Sort that traverses the array in both directions"
            + " during each pass",
    ...
    add(
        ...
        "O(n^2)",
        "O(1)",
        "Improves Insertion Sort by comparing and shifting elements at a shrinking gap before"
    ...
    add(
        ...
        "O(log n)",
        "O(1)",
        "Finds range where target exists by doubling index bounds, then performs binary search"
            + " within that range.",
    ...
    add(
        ...
        "O(n)",
        "O(1)",
        "Estimates target position based on key value distribution rather than splitting"
            + " midpoints.",
    ...
    add(
        ...
        "O(V+E)",
        "O(V)",
        "Explores deeply down one route before backtracking. It is fast to demonstrate but not"
    ...
    add(
        ...
        "O(V*E)",
        "O(V)",
        "Relaxation-based shortest path algorithm that iteratively relaxes all edges across the"
            + " graph.",
        "for i = 1 to V - 1:\n  for each edge (u, v):\n    relax(u, v)");
  }
  ...
  public static ComplexityInfo get(String name) {
    return INFO.getOrDefault(
        name,
        new ComplexityInfo(
            "-", "-", "-", "-", "No explanation available.", "No pseudocode available."));
  }
