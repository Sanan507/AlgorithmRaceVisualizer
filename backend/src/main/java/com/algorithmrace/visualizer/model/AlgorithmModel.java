...
public abstract class AlgorithmModel {
	...
	public int getMergeRegionStart() {
		return mergeRegionStart;
	}

	public int getMergeRegionEnd() {
		return mergeRegionEnd;
	}

	public int getHeapBoundary() {
		return heapBoundary;
	}
